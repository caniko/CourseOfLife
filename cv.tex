...
\cvsection{Bioscience experience}
	...
	\cvsection{Achievements}
		...
		\cvachievement{\faTrophy}{Athletics}{Ran Oslo marathon once, and Oslo half-marathon twice.}
	...
	\cvsection{Skills}
		...
		\cvskill{Go}{5}
		\cvskill{Latex}{4.5}
		\cvskill{FastAPI-OpenAPI}{5}

		\divider

		\cvskill{Arch Linux}{5}
		\cvskill{Terraform/OpenTofu}{4.5}
		\cvskill{Kubernetes}{4.5}
		\cvskill{Cassandra/Scylla DB}{4.5}
		\cvskill{TiKV}{5}
